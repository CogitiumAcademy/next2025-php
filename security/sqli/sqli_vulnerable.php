...
<body>
    ...
    <?php
        ...
        try {
            $query = "SELECT u.login, a.type, a.amount FROM accounts AS a LEFT JOIN users AS u ON a.id_users = u.id WHERE u.login = '" . $_POST['login'] . "' AND u.pass = '" . $_POST['password'] . "' ORDER BY 1,3";
